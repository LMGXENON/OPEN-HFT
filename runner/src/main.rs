//! Stratum Runner: High-performance execution simulation engine for Stratum,
...
fn rustc_version() -> String {
    option_env!("STRATUM_RUSTC").unwrap_or("unknown").to_string()
}
