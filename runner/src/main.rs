//! Open-HFT Runner: High-performance execution simulation engine for Open-HFT,
...
fn rustc_version() -> String {
    option_env!("OPEN_HFT_RUSTC").unwrap_or("unknown").to_string()
}
